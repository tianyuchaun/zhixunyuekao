package com.bawei.lianxi001.model;
...
import com.bawei.lianxi001.util.NetUtil;
...
public class HomeModel implements HomeContract.Imodel {
    ...
    public void getJsonData(String name, final IgsonModelCallBck igsonModelCallBck) {
        try {
            ...
            final String httpUrl = "http://172.17.8.100/small/commodity/v1/findCommodityByKeyword?page=1&count=30&keyword=" + encode;
